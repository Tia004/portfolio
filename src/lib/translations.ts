...
const it: Dict = {
  ...
  'bot.quote_review': 'Ho preparato una bozza del preventivo. Controllala con calma: non invierò nulla finché non mi dirai esplicitamente di procedere.',
  'bot.approve_quote': 'Va bene, invia il preventivo',
  'bot.sending_quote': 'Invio in corso…',
  'bot.revise_quote': 'No, voglio modificarlo',
  'bot.quote_sent': 'Perfetto: il preventivo è stato inviato. Ti porto al modulo di contatto con tutti i dati già compilati.',
...
const en: Dict = {
  ...
  'bot.quote_review': 'I prepared a quote draft. Review it carefully: nothing will be sent until you explicitly tell me to proceed.',
  'bot.approve_quote': 'Looks good, send the quote',
  'bot.sending_quote': 'Sending…',
  'bot.revise_quote': 'No, I want to revise it',
  'bot.quote_sent': 'Perfect: the quote was sent. I’m taking you to the contact form with the details already filled in.',
...
const es: Dict = {
  ...
  'bot.quote_review': 'He preparado un borrador del presupuesto. Revísalo con calma: no enviaré nada hasta que me digas explícitamente que proceda.',
  'bot.approve_quote': 'Está bien, enviar el presupuesto',
  'bot.sending_quote': 'Enviando…',
  'bot.revise_quote': 'No, quiero modificarlo',
  'bot.quote_sent': 'Perfecto: el presupuesto se ha enviado. Te llevo al formulario de contacto con los datos ya rellenados.',
