...
const it: Dict = {
  ...
  'processo.step1_desc': 'Prenotiamo una call gratuita. Parliamo del tuo progetto, dei tuoi obiettivi e delle tue esigenze.',
  'processo.step2_title': 'Analisi & Preventivo',
  'processo.step2_desc': 'Analizzo requisiti, tecnologie e fattibilità. Ti invio un preventivo dettagliato e trasparente.',
  'processo.step3_title': 'Design & Prototipazione',
  'processo.step3_desc': 'Creo wireframe, mockup e prototipi interattivi. Raffiniamo insieme fino alla versione definitiva.',
  'processo.step4_title': 'Sviluppo',
  'processo.step4_desc': 'Scrivo codice pulito e modulare. Ti tengo aggiornato con milestone settimanali e demo intermedie.',
  'processo.step5_title': 'Test & Revisioni',
  'processo.step5_desc': 'Testo ogni funzionalità, ottimizzo le performance e raccolgo il tuo feedback per le rifiniture finali.',
  'processo.step6_title': 'Consegna & Lancio',
  'processo.step6_desc': 'Deploy in produzione, documentazione e supporto post-lancio. Il progetto è tuo al 100%.',
...
const en: Dict = {
  ...
  'processo.step1_desc': 'We book a free call. We talk about your project, your goals and your needs.',
  'processo.step2_title': 'Analysis & Quote',
  'processo.step2_desc': 'I analyze requirements, technology and feasibility. I send you a detailed and transparent quote.',
  'processo.step3_title': 'Design & Prototyping',
  'processo.step3_desc': 'I create wireframes, mockups and interactive prototypes. We refine together to the final version.',
  'processo.step4_title': 'Development',
  'processo.step4_desc': 'I write clean, modular code. I keep you updated with weekly milestones and intermediate demos.',
  'processo.step5_title': 'Testing & Revisions',
  'processo.step5_desc': 'I test every feature, optimize performance and collect your feedback for final touches.',
  'processo.step6_title': 'Delivery & Launch',
  'processo.step6_desc': 'Production deployment, documentation and post-launch support. The project is 100% yours.',
...
const es: Dict = {
  ...
  'processo.step1_desc': 'Agendamos una llamada gratuita. Hablamos de tu proyecto, tus objetivos y tus necesidades.',
  'processo.step2_title': 'Análisis y Presupuesto',
  'processo.step2_desc': 'Analizo requisitos, tecnología y viabilidad. Te envío un presupuesto detallado y transparente.',
  'processo.step3_title': 'Diseño y Prototipado',
  'processo.step3_desc': 'Creo wireframes, mockups y prototipos interactivos. Refinamos juntos hasta la versión final.',
  'processo.step4_title': 'Desarrollo',
  'processo.step4_desc': 'Escribo código limpio y modular. Te mantengo al día con hitos semanales y demos intermedias.',
  'processo.step5_title': 'Pruebas y Revisiones',
  'processo.step5_desc': 'Pruebo cada funcionalidad, optimizo el rendimiento y recojo tus comentarios para los toques finales.',
  'processo.step6_title': 'Entrega y Lanzamiento',
  'processo.step6_desc': 'Despliegue en producción, documentación y soporte post-lanzamiento. El proyecto es 100% tuyo.',
