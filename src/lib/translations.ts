...
const it: Dict = {
  ...
  'chat.welcome_short': 'Puoi chiedermi qualsiasi cosa su un progetto: un sito, un\'app, un brand, un video, il tuo PC o i tuoi contenuti social.',
...
const en: Dict = {
  ...
  'chat.welcome_short': 'Ask me anything about a project: a website, an app, a brand, a video, your PC, or your social content.',
...
const es: Dict = {
  ...
  'chat.welcome_short': 'Pregúntame cualquier cosa sobre un proyecto: un sitio web, una app, una marca, un video, tu PC o tus contenidos para redes.',
