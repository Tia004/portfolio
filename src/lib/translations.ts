...
const REVIEWS_BY_LANG: Record<Lang, Review[]> = {
  it: [
    ...
    { name: 'Gianluca Rigodanza', role: 'iPalBoyTV — YouTuber', text: 'Le copertine che Tia ha realizzato per il mio canale (Copertine per iPalBoyTV) sono di un livello altissimo. Ha capito esattamente cosa volevo comunicare e lo ha trasformato in un\'immagine che mi rappresenta. Un vero professionista.', stars: 5, projectId: 'design-editoriale-2b' },
  ...
  en: [
    ...
    { name: 'Gianluca Rigodanza', role: 'iPalBoyTV — YouTuber', text: 'The covers Tia made for my channel (Covers for iPalBoyTV) are on another level. He understood exactly what I wanted to convey and turned it into an image that truly represents me. A real professional.', stars: 5, projectId: 'design-editoriale-2b' },
  ...
  es: [
    ...
    { name: 'Gianluca Rigodanza', role: 'iPalBoyTV — Youtuber', text: 'Las portadas que Tia hizo para mi canal (Portadas para iPalBoyTV) son de otro nivel. Entendió exactamente lo que quería comunicar y lo convirtió en una imagen que me representa. Un verdadero profesional.', stars: 5, projectId: 'design-editoriale-2b' },
...
const PROJECTS_BY_LANG: Record<Lang, ProjectData[]> = {
  it: [
    { id: 'gsa-hotels', title: 'GSA Hotels', description: 'Prototipo di sito luxury per struttura ricettiva di alto livello. Design raffinato, animazioni fluide e sistema di prenotazione interattivo.', url: 'https://gsa-hotels-demo.vercel.app/', thumbnail: '/uploads/gsahotels.webp', category: 'Sviluppo', tags: ['Next.js', 'Tailwind', 'Animazioni'] },
    { id: 'vergilius', title: 'Vergilius Nectar', description: 'Landing page per brand emergente. Visual identity curata, storytelling visivo d\'impatto e performance ottimizzate.', url: 'https://vergiliusnectar-github-io.vercel.app/', thumbnail: '/uploads/vergiliusnectar.webp', category: 'Sviluppo', tags: ['React', 'Branding', 'UI Design'] },
    { id: 'moretti', title: 'Studio Ing. Moretti', description: 'Sito professionale per studio di ingegneria. Design pulito, ottimizzato SEO e performance al top. Online e operativo.', url: 'https://www.studioingmoretti.it/', thumbnail: '/uploads/studioingmoretti.webp', category: 'Sviluppo', tags: ['Next.js', 'SEO', 'Sito Professionale'] },
    { id: 'pcs', title: 'PCS Mantova', description: 'Sito istituzionale per azienda del territorio mantovano. Struttura moderna, navigazione intuitiva e immagine coordinata.', url: 'https://pcsmantova-github-io.vercel.app/', thumbnail: '/uploads/pcsmantova.webp', category: 'Sviluppo', tags: ['Next.js', 'Design', 'Sviluppo'] },
    { id: 'canapa', title: 'Canapa Store', description: 'Concept store per prodotti naturali. Esperienza d\'acquisto fluida con design minimal, palette terrosa e attenzione al dettaglio.', url: 'https://canapa-store.vercel.app/', thumbnail: '/uploads/canapastore.webp', category: 'Sviluppo', tags: ['Next.js', 'E-commerce', 'UI Design'] },
    { id: 'showreel', title: 'Pigg', description: 'Cortometraggio realizzato per l\'Accademia di Belle Arti: la storia di un ragazzo bullizzato che si rimette in piedi da solo dopo che gli è stato affibbiato un nome che non gli appartiene.', url: 'https://youtu.be/rc6GzCBa2LY', thumbnail: '/uploads/pigg-cover.webp', isVideo: true, category: 'Video', tags: ['Cortometraggio', 'Montaggio', 'Color Grading'] },
  ],
  en: [
    { id: 'gsa-hotels', title: 'GSA Hotels', description: 'Luxury hotel website prototype. Elegant design, smooth animations, and interactive booking system.', url: 'https://gsa-hotels-demo.vercel.app/', thumbnail: '/uploads/gsahotels.webp', category: 'Sviluppo', tags: ['Next.js', 'Tailwind', 'Animations'] },
    { id: 'vergilius', title: 'Vergilius Nectar', description: 'Landing page for an emerging brand. Polished visual identity, impactful visual storytelling, and optimized performance.', url: 'https://vergiliusnectar-github-io.vercel.app/', thumbnail: '/uploads/vergiliusnectar.webp', category: 'Sviluppo', tags: ['React', 'Branding', 'UI Design'] },
    { id: 'moretti', title: 'Studio Ing. Moretti', description: 'Professional website for an engineering firm. Clean design, SEO-optimized, top performance. Live and operational.', url: 'https://www.studioingmoretti.it/', thumbnail: '/uploads/studioingmoretti.webp', category: 'Sviluppo', tags: ['Next.js', 'SEO', 'Professional Site'] },
    { id: 'pcs', title: 'PCS Mantova', description: 'Institutional website for a Mantua-based company. Modern structure, intuitive navigation, and coordinated branding.', url: 'https://pcsmantova-github-io.vercel.app/', thumbnail: '/uploads/pcsmantova.webp', category: 'Sviluppo', tags: ['Next.js', 'Design', 'Development'] },
    { id: 'canapa', title: 'Canapa Store', description: 'Concept store for natural products. Smooth shopping experience with minimal design, earthy palette, and attention to detail.', url: 'https://canapa-store.vercel.app/', thumbnail: '/uploads/canapastore.webp', category: 'Sviluppo', tags: ['Next.js', 'E-commerce', 'UI Design'] },
    { id: 'showreel', title: 'Pigg', description: 'Short film made for the Academy of Fine Arts: the story of a bullied boy who stands back up on his own after being given a name that doesn\'t belong to him.', url: 'https://youtu.be/rc6GzCBa2LY', thumbnail: '/uploads/pigg-cover.webp', isVideo: true, category: 'Video', tags: ['Short Film', 'Editing', 'Color Grading'] },
  ],
  es: [
    { id: 'gsa-hotels', title: 'GSA Hotels', description: 'Prototipo de sitio web de lujo para hotel de alto nivel. Diseño elegante, animaciones fluidas y sistema de reservas interactivo.', url: 'https://gsa-hotels-demo.vercel.app/', thumbnail: '/uploads/gsahotels.webp', category: 'Sviluppo', tags: ['Next.js', 'Tailwind', 'Animaciones'] },
    { id: 'vergilius', title: 'Vergilius Nectar', description: 'Landing page para marca emergente. Identidad visual cuidada, storytelling visual impactante y rendimiento optimizado.', url: 'https://vergiliusnectar-github-io.vercel.app/', thumbnail: '/uploads/vergiliusnectar.webp', category: 'Sviluppo', tags: ['React', 'Branding', 'UI Design'] },
    { id: 'moretti', title: 'Studio Ing. Moretti', description: 'Sitio profesional para estudio de ingeniería. Diseño limpio, optimizado SEO y máximo rendimiento. Online y operativo.', url: 'https://www.studioingmoretti.it/', thumbnail: '/uploads/studioingmoretti.webp', category: 'Sviluppo', tags: ['Next.js', 'SEO', 'Sitio Profesional'] },
    { id: 'pcs', title: 'PCS Mantova', description: 'Sitio institucional para empresa de la región de Mantua. Estructura moderna, navegación intuitiva e imagen coordinada.', url: 'https://pcsmantova-github-io.vercel.app/', thumbnail: '/uploads/pcsmantova.webp', category: 'Sviluppo', tags: ['Next.js', 'Diseño', 'Desarrollo'] },
    { id: 'canapa', title: 'Canapa Store', description: 'Concept store para productos naturales. Experiencia de compra fluida con diseño minimal, paleta terrosa y atención al detalle.', url: 'https://canapa-store.vercel.app/', thumbnail: '/uploads/canapastore.webp', category: 'Sviluppo', tags: ['Next.js', 'E-commerce', 'UI Design'] },
    { id: 'showreel', title: 'Pigg', description: 'Cortometraje realizado para la Academia de Bellas Artes: la historia de un chico acosado que se levanta por sí solo después de que le hayan puesto un nombre que no le pertenece.', url: 'https://youtu.be/rc6GzCBa2LY', thumbnail: '/uploads/pigg-cover.webp', isVideo: true, category: 'Video', tags: ['Cortometraje', 'Edición', 'Color Grading'] },
  ],
};
