        ...
        <div className="px-5 sm:px-12 py-5 sm:py-7 border-t border-white/[0.05]">
          <div className="max-w-3xl mx-auto flex flex-row items-end justify-between gap-2 sm:gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a
                href="https://t.me/+393318821334"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-sm font-medium text-[#24A1DE] hover:text-[#54b8ec] transition-colors self-start"
              >
                <svg aria-hidden="true" className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.446 1.394c-.14.18-.357.295-.6.295-.002 0-.003 0-.005 0l.213-3.054 5.56-5.022c.24-.213-.054-.334-.373-.121l-6.869 4.326-2.96-.924c-.643-.204-.657-.643.136-.953l11.57-4.461c.536-.196 1.006.128.832.916z" />
                </svg>
                Telegram
              </a>
            </div>
