...
export const metadata: Metadata = {
  title: 'Unsubscribe from the newsletter — Tia Designs',
...
export default async function NewsletterUnsubscribePage({ searchParams }: Props) {
  ...
  return <NewsletterActionPage mode="unsubscribe" lang="en" token={first(params.token)} esito={first(params.esito)} />;
}
